...
### 🚖 Uber Trip Analysis
- End-to-end analytics project using Python, SQL, Power BI, and Matplotlib.
- Generated business insights with interactive dashboards and SQL analysis.

### ⚡ EV Charging Station Analytics
- Data analysis project using Python, SQL, and Power BI.
- Performed EDA and created an interactive dashboard.

---

## 🎯 Career Objective

I am passionate about transforming raw data into meaningful insights through analytics and visualization. I am looking for opportunities where I can apply my analytical skills, continue learning, and contribute to data-driven decision making.
